$(".fp").click(function(){
    $(".login").slideUp("500");
    $(".forgotPass").slideDown("500");
});
$(".LBtn").click(function(){
    $(".forgotPass").slideUp("500");
    $(".login").slideDown("500");
});
...
//     $('#navbarSupportedContent ul ul').each(function(){
//     	var ulheight = 300;
     
// 	    $(this).each(function(){
// 	        if($(this).height() >= ulheight) {
// 	        	$("#navbarSupportedContent ul .dropd_").append("<a  class='more' style='color: #43b97e;'>View More »</a> ");
// 	        	return false;
// 	        }
// 	        else{
//                 return true;
