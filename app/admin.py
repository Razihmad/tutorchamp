...
from app.models import Orders, TutorEarnedDetail, TutorPaymenyDetails, TutorSolvedLabs, UserDetails,TutorRegister,Blog,TutorSolvedAssignment,TutorAccount,LabOrders,TutorBalance
