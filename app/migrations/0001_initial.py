    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission_date', models.DateField(default=datetime.date(2022, 3, 12))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Awaiting Confirmation', 'Awaiting Confirmation'), ('Order Confirmed', 'Order Confirmed'), ('Payment Done', 'Payment Done'), ('Order Rejected', 'Order Rejected'), ('Assignment In Progress', 'Assignment In Progress'), ('Review Your Assignment', 'Review Your Assignment'), ('Assignment Under Revision', 'Assignment Under Revision'), ('Assignment Completed', 'Assignment Completed')], max_length=100)),
                ('submission_date', models.DateField(default=datetime.date(2022, 3, 12))),
                ('assigned', models.BooleanField(default=False)),
                ('reference_material', models.ImageField(blank=True, null=True, upload_to='')),
                ('amount', models.IntegerField(default=0)),
                ('assignment_completed_file', models.FileField(upload_to='')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Order',
